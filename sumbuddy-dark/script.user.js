// ==UserScript==
// @name              Sumbuddy Dark
// @name:zh-CN        Sumbuddy 深色模式
// @namespace         https://screw-hand.com/
// @version           0.1.1
// @description       Add dark mode support to the Sumbuddy website, fully compatible with the Dark Reader extension.
// @description:zh-CN 为 Sumbuddy 网站添加暗色模式支持，与 Dark Reader 扩展完美兼容。
// @author            GinWU
// @license           MIT
// @homepageURL       https://github.com/screw-hand/tampermonkey-user.js/tree/main/sumbuddy-dark
